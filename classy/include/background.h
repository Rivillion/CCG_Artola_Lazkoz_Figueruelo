...
enum equation_of_state {CLP,EDE,SQRT,TANH}; /** <--- Modified by Artola M. 2026 */
...
struct background
{
  ...
  double n_sigmoid; /**< \f$ n_{sigmoid} \f$: exponent for the fluid sigmoid equation of state <--- Modified by Artola M. 2026 */
