...
int input_read_parameters_species(struct file_content * pfc,
  ...
  if (pba->Omega0_fld != 0.) {
    ...
    /** 8.a.2) Equation of state <--- Modified by Artola M. 2026*/
    /* Read */
    ...
    if (flag1 == _TRUE_) {
      if ((strstr(string1,"CLP") != NULL) || (strstr(string1,"clp") != NULL)) {
        ...
        pba->fluid_equation_of_state = SQRT;
      }
      else if ((strstr(string1,"TANH") != NULL) || (strstr(string1,"tanh") != NULL)) {
    ...
    if (pba->fluid_equation_of_state == SQRT || pba->fluid_equation_of_state == TANH) {
      /** 8.a.2.1) Equation of state of the fluid in 'SQRT' or 'TANH' case */
      /* Read */
      class_read_double("w0_fld",pba->w0_fld);
      class_read_double("wa_fld",pba->wa_fld);
      class_read_double("cs2_fld",pba->cs2_fld);
      class_read_double("n_sigmoid",pba->n_sigmoid);
    }
